  ...
  return (
    <section className="pt-32 pb-20 relative hero-bg overflow-hidden">
      <div className="absolute inset-0 animate-background"
        style={{background: 'radial-gradient(circle at 50% 50%, rgba(124, 58, 237, 0.2) 0%, rgba(15, 15, 26, 0) 70%)'}}></div>

      {/* Animated Circles */}
      <div className="absolute top-1/4 left-1/4 w-64 h-64 rounded-full bg-purple-500/10 animate-pulse-slow"></div>
      <div className="absolute bottom-1/4 right-1/4 w-80 h-80 rounded-full bg-purple-600/10 animate-pulse-slow"
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-10 md:mb-0">
            ...
            <p className="text-gray-300 text-lg mb-8">Build AI Agents that automate real-world business tasks. Join us for a hybrid hackathon experience with amazing prizes and career opportunities.</p>
            ...
            <div className="mt-10 flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm text-gray-300">Join <span className="text-purple-300 font-medium">500+</span> innovators</p>
                <p className="text-xs text-gray-400">Registration closing soon</p>
              </div>
            </div>
          </div>
          ...
          <div className="md:w-1/2 relative">
              ...
              <div className="absolute inset-0 bg-[#0F0F1A] flex items-center justify-center">
                <div className="relative">
                  ...
                  <svg className="absolute top-0 left-0 w-full h-full" viewBox="0 0 200 200">
                    ...
                    <path d="M100,100 L100,20" stroke="url(#purpleGradient)" strokeWidth="2" strokeDasharray="5,5"></path>
                    <path d="M100,100 L100,180" stroke="url(#purpleGradient)" strokeWidth="2" strokeDasharray="5,5"></path>
                    <path d="M100,100 L20,100" stroke="url(#purpleGradient)" strokeWidth="2" strokeDasharray="5,5"></path>
                    <path d="M100,100 L180,100" stroke="url(#purpleGradient)" strokeWidth="2" strokeDasharray="5,5"></path>
                  </svg>
                </div>
              </div>
              ...
              <div className="absolute bottom-4 left-4 right-4 h-20 bg-[#1a1a2e]/80 rounded-lg p-2 overflow-hidden">
                <div className="animate-pulse-slow">
                  <div className="text-xs font-mono text-purple-300">
                    <span className="text-green-400">class</span> <span className="text-yellow-400">AIAgent</span>:
                  </div>
                  <div className="text-xs font-mono text-purple-300 pl-4">
                    <span className="text-green-400">def</span> <span className="text-blue-400">automate_task</span>(self, task):
                  </div>
                  <div className="text-xs font-mono text-purple-300 pl-8">
                    <span className="text-purple-400">return</span> self.ai.process(task)
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="absolute -bottom-8 -left-8 w-24 h-24 rounded-full bg-purple-500/20 animate-float"
        ...
        <div className="mt-16 text-center">
          ...
          <div className="flex items-center justify-center">
            ...
            <h3 className="text-2xl font-bold">WeSee <span className="text-purple-400">Japan</span></h3>
          </div>
          <p className="text-gray-300 mt-2 max-w-lg mx-auto">Japan-Based AI &amp; Blockchain Company focused on transforming business operations through smart automation</p>
        </div>

        {/* Stats */}
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6">
          <div className="gradient-border p-6 text-center card-hover">
            <h3 className="text-3xl font-bold gradient-text">¥20,000</h3>
            <p className="text-gray-300 mt-2">First Prize</p>
          </div>
          <div className="gradient-border p-6 text-center card-hover">
          ...
          <div className="gradient-border p-6 text-center card-hover">
            ...
            <p className="text-gray-300 mt-2">Internship Offers</p>
          </div>
        </div>
      </div>
    </section>
